...
import { removeAllStudents } from "../../../../data/extensions/ClassroomV2Extensions";
...
class DeleteRoute extends APIRoute<boolean, ClassroomStudentsEndpointV2> {
    ...
    protected async doHandle(req: Request): Promise<APIResponse<boolean>> {
        ...
        return this.success((await removeAllStudents(classroom, this.server.db.classroomsV2, this.server.db.users)).success);
    }
}
