...
class GetRoute extends APIRoute<int, ClassroomStudentTokenEndpoint> {
    public constructor(endpoint: ClassroomStudentTokenEndpoint) {
...
class PostRoute extends APIRoute<int, ClassroomStudentTokenEndpoint> {
    public constructor(endpoint: ClassroomStudentTokenEndpoint) {
...
export default class ClassroomStudentTokenEndpoint extends APIEndpoint {

    private readonly _get: GetRoute;
    private readonly _post: PostRoute;

    public constructor(controller: APIController) {
        super(controller, "/classrooms/:code/students/:email/tokens", "classroom-student-tokens", 1);
