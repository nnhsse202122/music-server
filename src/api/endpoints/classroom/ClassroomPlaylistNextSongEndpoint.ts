...
class PostRoute extends APIRoute<ClassroomSongV2, ClassroomPlaylistNextSongEndpoint> {

    public constructor(endpoint: ClassroomPlaylistNextSongEndpoint) {
...
export default class ClassroomPlaylistNextSongEndpoint extends APIEndpoint {

    private readonly _post: PostRoute;

    public constructor(controller: APIController) {
        super(controller, "/classrooms/:code/playlist/next-song", "next-class-playlist-song", 2);
