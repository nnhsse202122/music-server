...
declare namespace gapi.auth2 {
     ...
     * 
     * @param params An object containing key-value pairs of client configuration data. See gapi.auth2.ClientConfig for the different properties configurable. For example:
     * ```js
     * {
     *   client_id: 'CLIENT_ID.apps.googleusercontent.com'
     * }
     * ```
     * @returns The `gapi.auth2.GoogleAuth` object. Use the `then()` method to get a Promise that is resolved when the `gapi.auth2.GoogleAuth` object finishes initializing.
     */
    export function init(params: ClientConfig): GoogleAuth;

    /**
     * Returns the `GoogleAuth` object. You must initialize the GoogleAuth object with `gapi.auth2.init()` before calling this method.
     * @returns 	The gapi.auth2.GoogleAuth object. Use this object to call gapi.auth2.GoogleAuth's methods.
     */
    ...
    export interface GoogleAuth {
         ...
         * @param onInit The function called with the GoogleAuth object when it is fully initialized.
         * @param onError The function called with an object containing an error property, if GoogleAuth failed to initialize.
         * @returns A Promise that is fulfilled when the onInit function has completed, or rejected if an initialization error was raised. It resolves with the returned value from the onInit function, if any.
         */
        then(onInit?: (arg: GoogleAuth) => any, onError?: (arg: { error: any }) => any): Promise<GoogleAuth>; 

        /**
         * Signs out the current account from the application.
         * @returns A `Promise` that is fulfilled when the user has been signed out.
         */
    ...
    export interface GoogleUser {
         ...
         * @returns The user's G Suite domain
         */
